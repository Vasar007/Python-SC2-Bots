...
train_data_dir = "train_data_14_choices/out_of_sample"
...
def main():
    ...
    try:
        ...
        np.save("train_data_14_choices/out_of_sample/x_oos.npy", x_oos)
        np.save("train_data_14_choices/out_of_sample/y_oos.npy", y_oos)
